...
zip_path = 'amplitude_data_2025-01-16_142522.zip'

with zipfile.ZipFile(zip_path, 'r') as zip_ref:
    zip_ref.extractall(temp_dir)
    print(f"Extract {zip_path} to {temp_dir}")
    ...
    for file in files:
        ...
        with gzip.open(gz_path, 'rb') as gz_file:
            with open(output_path, 'wb') as output_file:
                ...
                s3_client.upload_file(output_path, aws_bucket_name, aws_file_destination, ExtraArgs = {'ServerSideEncryption':'aws:kms', 'SSEKMSKeyId':aws_kms_key})
